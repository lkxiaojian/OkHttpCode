...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
  ...
  public static final class Builder {
    ...
    public Builder() {
      ...
      authenticator = Authenticator.NONE;//连接复用池
    ...
    Builder(OkHttpClient okHttpClient) {
      ...
      this.interceptors.addAll(okHttpClient.interceptors);//自定义的拦截器
      this.networkInterceptors.addAll(okHttpClient.networkInterceptors);//网络拦截器
      this.eventListenerFactory = okHttpClient.eventListenerFactory;
      this.proxySelector = okHttpClient.proxySelector;
      this.cookieJar = okHttpClient.cookieJar;
      this.internalCache = okHttpClient.internalCache;//内部缓存
      this.cache = okHttpClient.cache;//创建OkHttpClient对象时的自定义缓存
